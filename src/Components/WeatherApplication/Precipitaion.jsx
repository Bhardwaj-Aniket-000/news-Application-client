            ...
            <div className="flex items-start flex-col mt-2">
              ...
              <div className="flex items-center mt-2">
                <img
                  ...
                  className="w-7 md:w-10 mr-1"
                />
                <p className="text-xl md:text-3xl font-semibold">
                  {weatherinfo.currentPrecip} mm ,
                </p>
                <p className="text-xl md:text-3xl font-semibold">
                  {weatherinfo.currentPrecipIN} In
                </p>
              </div>
            </div>
            <p className="capitalize font-medium text-xs md:text-sm mt-2">
              Full Day Amount of Precip. mm : {weatherinfo.fullDayPrecip} mm
            </p>
            <p className="capitalize font-medium text-xs md:text-sm">
              Full Day Amount of Precip. Inch: {weatherinfo.fullDayPrecipIN} In
            </p>
          </div>
          <Slider
            {...settings}
                  ...
                  <div className="flex flex-col gap-2 w-[90%] rounded-md bg-slate-200 p-2">
                    ...
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <img
                        src={precipitationIcon}
                        alt="precipitaion-icon"
                        className="w-5 md:w-12 mt-3"
                      />
                    </div>
                    <p className="text-center text-xs md:text-sm font-normal md:font-medium">
                      {obj.precip_mm} mm
                    </p>
                    <span className="text-center text-xs md:text-sm font-normal md:font-medium">
                      {obj.precip_in} In
                    </span>
                  </div>
                </div>
