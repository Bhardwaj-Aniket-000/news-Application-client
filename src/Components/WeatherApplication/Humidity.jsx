  ...
  <WeatherSpinner />
    ...
    <div className='w-[80%] p-4 pl-8 flex text-black gap-4 flex-col'>
        <div className='p-3 flex flex-col justify-center'>
            <h1 className=' text-xl font-bold text-red-700 uppercase underline'>humidity</h1>
            ...
            <div className='flex items-start flex-col mt-2'>
              ...
              <div className='flex items-center mt-2'>
                <img src={humidityIcon} alt="current humidity icon" className='w-10 mt-2'/>
                <p className='text-3xl font-semibold'>{weatherinfo.Humidity}%</p>
              </div>
            </div>
            <p className='capitalize font-medium text-sm'>average of humidity : {weatherinfo.avg_humidity}% </p>
        </div>
                ...
                <div key={ind}>
                  <div className='flex flex-col gap-2 w-[90%] rounded-md bg-slate-200 p-2'>
                      ...
                      <div className='flex items-center'>
                        <img src={humidityIcon} alt="humidity-icon" className='w-12 mt-2'/>
                        <p className="text-center text-sm font-medium">{obj.humidity}%</p>
                      </div>
                  </div>
                </div>
              )
